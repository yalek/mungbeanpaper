...
#To run this file. You will need access to the SNP data for genotypic dendogram
```
...
```{r}
#read data
#bring in SNP Data (You will need access to SNP data)
...
tiff("./figures/supplementary/day18_pheno_cluster_no.tiff", width = 12, height = 14, units = 'in', res = 120)
...
#Circlize dendrogram - uncomment to see circular dendogram
# circlize_dendrogram(dend_Day18_pheno,dend_track_height = 0.5)
# legend("center",
...
tiff("./figures/fig5_dendogram/day18/Dendo_18_pheno.tiff", width = 7, height = 7, units = 'in', res = 200)
par(mar=c(0, 0, 0, 0))
...
tiff("./figures/supplementary/day18_geno_cluster_no.tiff", width = 12, height = 14, units = 'in', res = 120)
...
##save
write.csv(day18_geno_summary, "./figures/fig4_dendogram/day18/Cluster_Summary/day18_geno_summary.csv", row.names = F)
write.csv(day18_geno_summary_1, "./figures/fig4_dendogram/day18/Cluster_Summary/day18_geno_count.csv", row.names = F)
```
...
# output dendrogram as TIFF File
tiff("./figures/fig4_dendogram/day18/Dendo_18_geno.tiff", width = 7, height = 7, units = 'in', res = 200)
par(mar=c(0, 0, 0, 0))
...
##You will need access to SNP  Marker ##########
...
tiff("./figures/supplementary/day15_pheno_cluster_no.tiff", width = 12, height = 14, units = 'in', res = 120)
print(fviz_nbclust(nb))
...
#Circlize dendrogram - uncomment to see circular dendogram
# circlize_dendrogram(dend_Day15_pheno,dend_track_height = 0.5)
# legend("center",
#      legend = c("Afghanistan" , "Australia" , "India" , "Others" , "Pakistan", "Thailand", "United Kingdom", "United States"),
#      col = c("#000000", "#CC0066" , "#32CD32" , "#3399FF" , "#00FFFF", "#FF00FF","#FFA500","#C0C0C0"),
#      fill = c("#000000", "#CC0066" , "#32CD32" , "#3399FF" , "#00FFFF", "#FF00FF","#FFA500","#C0C0C0")
...
##finding clusters
#The above method lets us deduce the no. of clusters from the dendogram
tiff("./figures/supplementary/day15_geno_cluster_no.tiff", width = 12, height = 14, units = 'in', res = 120)
fviz_nbclust(df.mat_geno, FUNcluster = hcut, method = "silhouette") #hcut- h clustering
