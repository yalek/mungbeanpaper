...
# CMplot(overall,type="p",plot.type="c",
#        chr.labels=paste("Chr",c(1:11),sep=""),r=0.4,cex = c(0.3),outward=FALSE,cir.legend.col="black", threshold = c(1e-5),
...
Markers <- list(
  overall$Marker[overall$LRA_Day_12 <1e-5],
	...
	overall$Marker[overall$VOL <1e-5],
	overall$Marker[overall$LED <1e-5],
	overall$Marker[overall$TDW <1e-5],
	overall$Marker[overall$TRL_GR <1e-5]
)
